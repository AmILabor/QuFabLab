...
{
    /// <summary>
    /// Managing of the Spatial Coordinates for QR Codes
    /// </summary>
        ...
        {
            {
                ...
                if (CoordinateSystem != null)
                {
                    ...
                    SpatialCoordinateSystem rootSpatialCoordinateSystem =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 PerceptionInterop.GetSceneCoordinateSystem(UnityEngine.Pose.identity) as SpatialCoordinateSystem;

                    // Get the relative transform from the unity origin
                    System.Numerics.Matrix4x4? relativePose =
