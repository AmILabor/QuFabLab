...
from api.filters.AdminFilters import UsersFilter, WorkshopFilter
...
class AdminWorkshopViewSet(AdminViewSet):
    ...
    def patch(self, request, pk=None):
        object = get_object_or_404(pk=pk,queryset=self.get_queryset())
