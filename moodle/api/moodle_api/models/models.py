...
class MdlAdminpresets(models.Model):
    ...
    moodleversion = models.CharField(max_length=20)
    moodlerelease = models.CharField(max_length=255)
    iscore = models.IntegerField()
    timecreated = models.BigIntegerField()
    timeimported = models.BigIntegerField()

    class Meta:
        managed = False
        db_table = 'mdl_adminpresets'


class MdlAdminpresetsApp(models.Model):
    id = models.BigAutoField(primary_key=True)
    adminpresetid = models.BigIntegerField()
    userid = models.BigIntegerField()
    time = models.BigIntegerField()

    class Meta:
        managed = False
        db_table = 'mdl_adminpresets_app'


class MdlAdminpresetsAppIt(models.Model):
    id = models.BigAutoField(primary_key=True)
    adminpresetapplyid = models.BigIntegerField()
    configlogid = models.BigIntegerField()

    class Meta:
        managed = False
        db_table = 'mdl_adminpresets_app_it'


class MdlAdminpresetsAppItA(models.Model):
    id = models.BigAutoField(primary_key=True)
    adminpresetapplyid = models.BigIntegerField()
    configlogid = models.BigIntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'mdl_adminpresets_app_it_a'


class MdlAdminpresetsAppPlug(models.Model):
    id = models.BigAutoField(primary_key=True)
    adminpresetapplyid = models.BigIntegerField()
    plugin = models.CharField(max_length=100, blank=True, null=True)
    name = models.CharField(max_length=100)
    value = models.SmallIntegerField()
    oldvalue = models.SmallIntegerField()

    class Meta:
        managed = False
        db_table = 'mdl_adminpresets_app_plug'


class MdlAdminpresetsIt(models.Model):
    id = models.BigAutoField(primary_key=True)
    adminpresetid = models.BigIntegerField()
    plugin = models.CharField(max_length=100, blank=True, null=True)
    name = models.CharField(max_length=100)
    ...
    class Meta:
        managed = False
        db_table = 'mdl_adminpresets_it'


class MdlAdminpresetsItA(models.Model):
    id = models.BigAutoField(primary_key=True)
    ...
    class Meta:
        managed = False
        db_table = 'mdl_adminpresets_it_a'


class MdlAdminpresetsPlug(models.Model):
    id = models.BigAutoField(primary_key=True)
    adminpresetid = models.BigIntegerField()
    plugin = models.CharField(max_length=100, blank=True, null=True)
    name = models.CharField(max_length=100)
    ...
    class Meta:
        managed = False
        db_table = 'mdl_adminpresets_plug'
...
class MdlAssign(models.Model):
    ...
    activityformat = models.SmallIntegerField()
    timelimit = models.BigIntegerField()
    submissionattachments = models.IntegerField()
...
class MdlAssignSubmission(models.Model):
    ...
    timecreated = models.BigIntegerField()
    timemodified = models.BigIntegerField()
    timestarted = models.BigIntegerField(blank=True, null=True)
...
class MdlAuthLtiLinkedLogin(models.Model):
    id = models.BigAutoField(primary_key=True)
    userid = models.BigIntegerField()
    issuer = models.TextField()
    issuer256 = models.CharField(max_length=64)
    sub = models.CharField(max_length=255)
    sub256 = models.CharField(max_length=64)
    timecreated = models.BigIntegerField()
    timemodified = models.BigIntegerField()

    class Meta:
        managed = False
        db_table = 'mdl_auth_lti_linked_login'
        unique_together = (('userid', 'issuer256', 'sub256'),)
...
class MdlBadgeBackpack(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('userid', 'externalbackpackid'),)
...
class MdlBigbluebuttonbn(models.Model):
    id = models.BigAutoField(primary_key=True)
    type = models.IntegerField()
    course = models.BigIntegerField()
    name = models.CharField(max_length=255)
    ...
    recordallfromstart = models.IntegerField()
    recordhidebutton = models.IntegerField()
    ...
    recordings_html = models.IntegerField()
    recordings_deleted = models.IntegerField()
    recordings_imported = models.IntegerField()
    recordings_preview = models.IntegerField()
    clienttype = models.IntegerField()
    muteonstart = models.IntegerField()
    disablecam = models.IntegerField()
    disablemic = models.IntegerField()
    disableprivatechat = models.IntegerField()
    disablepublicchat = models.IntegerField()
    disablenote = models.IntegerField()
    hideuserlist = models.IntegerField()
    lockedlayout = models.IntegerField()
    completionattendance = models.IntegerField()
    completionengagementchats = models.IntegerField()
    completionengagementtalks = models.IntegerField()
    completionengagementraisehand = models.IntegerField()
    completionengagementpollvotes = models.IntegerField()
    completionengagementemojis = models.IntegerField()
    guestallowed = models.IntegerField(blank=True, null=True)
    mustapproveuser = models.IntegerField(blank=True, null=True)
    guestlinkuid = models.CharField(max_length=1024, blank=True, null=True)
    guestpassword = models.CharField(max_length=255, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'mdl_bigbluebuttonbn'


class MdlBigbluebuttonbnLogs(models.Model):
    id = models.BigAutoField(primary_key=True)
    ...
    class Meta:
        managed = False
        db_table = 'mdl_bigbluebuttonbn_logs'


class MdlBigbluebuttonbnRecordings(models.Model):
    id = models.BigAutoField(primary_key=True)
    courseid = models.BigIntegerField()
    bigbluebuttonbnid = models.BigIntegerField()
    groupid = models.BigIntegerField(blank=True, null=True)
    recordingid = models.CharField(max_length=64)
    headless = models.IntegerField()
    imported = models.IntegerField()
    status = models.IntegerField()
    importeddata = models.TextField(blank=True, null=True)
    timecreated = models.BigIntegerField()
    usermodified = models.BigIntegerField()
    timemodified = models.BigIntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'mdl_bigbluebuttonbn_recordings'
...
class MdlChoice(models.Model):
    ...
    timemodified = models.BigIntegerField()
    completionsubmit = models.IntegerField()
    showavailable = models.IntegerField()
...
class MdlCompetencyModulecomp(models.Model):
    ...
    competencyid = models.BigIntegerField()
    ruleoutcome = models.IntegerField()
    overridegrade = models.IntegerField()
...
class MdlCourseCompletionDefaults(models.Model):
    ...
    completionpassgrade = models.IntegerField()
...
class MdlCourseModulesViewed(models.Model):
    id = models.BigAutoField(primary_key=True)
    coursemoduleid = models.BigIntegerField()
    userid = models.BigIntegerField()
    timecreated = models.BigIntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'mdl_course_modules_viewed'
        unique_together = (('userid', 'coursemoduleid'),)
...
class MdlEnrolLtiAppRegistration(models.Model):
    id = models.BigAutoField(primary_key=True)
    name = models.CharField(max_length=255)
    platformid = models.TextField(blank=True, null=True)
    clientid = models.CharField(max_length=1333, blank=True, null=True)
    uniqueid = models.CharField(unique=True, max_length=255)
    platformclienthash = models.CharField(unique=True, max_length=64, blank=True, null=True)
    platformuniqueidhash = models.CharField(unique=True, max_length=64, blank=True, null=True)
    authenticationrequesturl = models.TextField(blank=True, null=True)
    jwksurl = models.TextField(blank=True, null=True)
    accesstokenurl = models.TextField(blank=True, null=True)
    status = models.IntegerField()
    timecreated = models.BigIntegerField()
    timemodified = models.BigIntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'mdl_enrol_lti_app_registration'


class MdlEnrolLtiContext(models.Model):
    id = models.BigAutoField(primary_key=True)
    contextid = models.CharField(max_length=255)
    ltideploymentid = models.BigIntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'mdl_enrol_lti_context'
        unique_together = (('ltideploymentid', 'contextid'),)


class MdlEnrolLtiDeployment(models.Model):
    id = models.BigAutoField(primary_key=True)
    name = models.CharField(max_length=255)
    deploymentid = models.CharField(max_length=255)
    platformid = models.BigIntegerField()
    legacyconsumerkey = models.CharField(max_length=255, blank=True, null=True)
    timecreated = models.BigIntegerField()
    timemodified = models.BigIntegerField()

    class Meta:
        managed = False
        db_table = 'mdl_enrol_lti_deployment'
        unique_together = (('platformid', 'deploymentid'),)
...
class MdlEnrolLtiResourceLink(models.Model):
    id = models.BigAutoField(primary_key=True)
    resourcelinkid = models.CharField(max_length=255)
    ltideploymentid = models.BigIntegerField()
    resourceid = models.BigIntegerField()
    lticontextid = models.BigIntegerField(blank=True, null=True)
    lineitemsservice = models.CharField(max_length=1333, blank=True, null=True)
    lineitemservice = models.CharField(max_length=1333, blank=True, null=True)
    lineitemscope = models.CharField(max_length=255, blank=True, null=True)
    resultscope = models.CharField(max_length=255, blank=True, null=True)
    scorescope = models.CharField(max_length=255, blank=True, null=True)
    contextmembershipsurl = models.CharField(max_length=1333, blank=True, null=True)
    nrpsserviceversions = models.CharField(max_length=255, blank=True, null=True)
    timecreated = models.BigIntegerField()
    timemodified = models.BigIntegerField()

    class Meta:
        managed = False
        db_table = 'mdl_enrol_lti_resource_link'
        unique_together = (('resourcelinkid', 'ltideploymentid'),)
...
class MdlEnrolLtiTools(models.Model):
    ...
    contextid = models.BigIntegerField()
    ltiversion = models.CharField(max_length=15)
    ...
    provisioningmodelearner = models.IntegerField(blank=True, null=True)
    provisioningmodeinstructor = models.IntegerField(blank=True, null=True)
    timecreated = models.BigIntegerField()
    timemodified = models.BigIntegerField()
...
class MdlEnrolLtiUserResourceLink(models.Model):
    id = models.BigAutoField(primary_key=True)
    ltiuserid = models.BigIntegerField()
    resourcelinkid = models.BigIntegerField()

    class Meta:
        managed = False
        db_table = 'mdl_enrol_lti_user_resource_link'
        unique_together = (('ltiuserid', 'resourcelinkid'),)
...
class MdlEnrolLtiUsers(models.Model):
    ...
    ltideploymentid = models.BigIntegerField(blank=True, null=True)
    consumerkey = models.TextField(blank=True, null=True)
...
class MdlFolder(models.Model):
    ...
    forcedownload = models.IntegerField()
...
class MdlH5PLibraries(models.Model):
    ...
    tutorial = models.TextField(blank=True, null=True)
...
class MdlInfectedFiles(models.Model):
    id = models.BigAutoField(primary_key=True)
    filename = models.TextField()
    quarantinedfile = models.TextField(blank=True, null=True)
    userid = models.BigIntegerField()
    reason = models.TextField()
    timecreated = models.BigIntegerField()
...
class MdlLti(models.Model):
    ...
    instructorcustomparameters = models.TextField(blank=True, null=True)
...
class MdlLtiserviceGradebookservices(models.Model):
    ...
    subreviewurl = models.TextField(blank=True, null=True)
    subreviewparams = models.TextField(blank=True, null=True)
...
class MdlOauth2Issuer(models.Model):
    ...
    loginpagename = models.CharField(max_length=255, blank=True, null=True)
...
class MdlOauth2RefreshToken(models.Model):
    id = models.BigAutoField(primary_key=True)
    timecreated = models.BigIntegerField()
    timemodified = models.BigIntegerField()
    userid = models.BigIntegerField()
    issuerid = models.BigIntegerField()
    token = models.TextField()
    scopehash = models.CharField(max_length=40)

    class Meta:
        managed = False
        db_table = 'mdl_oauth2_refresh_token'
        unique_together = (('userid', 'issuerid', 'scopehash'),)
...
class MdlOauth2UserFieldMapping(models.Model):
    ...
    usermodified = models.BigIntegerField()
    issuerid = models.BigIntegerField()
    externalfield = models.CharField(max_length=500)
...
class MdlPaygwPaypal(models.Model):
    id = models.BigAutoField(primary_key=True)
    paymentid = models.BigIntegerField(unique=True)
    pp_orderid = models.CharField(max_length=255)

    class Meta:
        managed = False
        db_table = 'mdl_paygw_paypal'


class MdlPaymentAccounts(models.Model):
    id = models.BigAutoField(primary_key=True)
    name = models.CharField(max_length=255)
    idnumber = models.CharField(max_length=100, blank=True, null=True)
    contextid = models.BigIntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'mdl_payment_accounts'


class MdlPaymentGateways(models.Model):
    id = models.BigAutoField(primary_key=True)
    ...
    class Meta:
        managed = False
        db_table = 'mdl_payment_gateways'


class MdlPayments(models.Model):
    id = models.BigAutoField(primary_key=True)
    component = models.CharField(max_length=100)
    paymentarea = models.CharField(max_length=50)
    itemid = models.BigIntegerField()
    userid = models.BigIntegerField()
...
class MdlQtypeEssayOptions(models.Model):
    ...
    minwordlimit = models.BigIntegerField(blank=True, null=True)
    maxwordlimit = models.BigIntegerField(blank=True, null=True)
...
class MdlQuestionBankEntries(models.Model):
    id = models.BigAutoField(primary_key=True)
    questioncategoryid = models.BigIntegerField()
    idnumber = models.CharField(max_length=100, blank=True, null=True)
    ownerid = models.BigIntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'mdl_question_bank_entries'
        unique_together = (('questioncategoryid', 'idnumber'),)
...
class MdlQuestionCategories(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('contextid', 'stamp'), ('contextid', 'idnumber'),)
...
class MdlQuestionReferences(models.Model):
    id = models.BigAutoField(primary_key=True)
    usingcontextid = models.BigIntegerField()
    component = models.CharField(max_length=100, blank=True, null=True)
    questionarea = models.CharField(max_length=50, blank=True, null=True)
    itemid = models.BigIntegerField(blank=True, null=True)
    questionbankentryid = models.BigIntegerField()
    version = models.BigIntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'mdl_question_references'
        unique_together = (('usingcontextid', 'component', 'questionarea', 'itemid'),)
...
class MdlQuestionSetReferences(models.Model):
    id = models.BigAutoField(primary_key=True)
    usingcontextid = models.BigIntegerField()
    component = models.CharField(max_length=100, blank=True, null=True)
    questionarea = models.CharField(max_length=50, blank=True, null=True)
    itemid = models.BigIntegerField(blank=True, null=True)
    questionscontextid = models.BigIntegerField()
    filtercondition = models.TextField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'mdl_question_set_references'
        unique_together = (('usingcontextid', 'component', 'questionarea', 'itemid'),)
...
class MdlQuestionVersions(models.Model):
    id = models.BigAutoField(primary_key=True)
    questionbankentryid = models.BigIntegerField()
    version = models.BigIntegerField()
    questionid = models.BigIntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'mdl_question_versions'
...
class MdlQuiz(models.Model):
    ...
    completionminattempts = models.BigIntegerField()
    allowofflineattempts = models.IntegerField(blank=True, null=True)
...
class MdlQuizAttempts(models.Model):
    ...
    gradednotificationsenttime = models.BigIntegerField(blank=True, null=True)
...
class MdlReportbuilderAudience(models.Model):
    id = models.BigAutoField(primary_key=True)
    ...
    class Meta:
        managed = False
        db_table = 'mdl_reportbuilder_audience'


class MdlReportbuilderColumn(models.Model):
    id = models.BigAutoField(primary_key=True)
    reportid = models.BigIntegerField()
    uniqueidentifier = models.CharField(max_length=255)
    aggregation = models.CharField(max_length=32, blank=True, null=True)
    heading = models.CharField(max_length=255, blank=True, null=True)
    columnorder = models.BigIntegerField()
    sortenabled = models.IntegerField()
    sortdirection = models.IntegerField()
    sortorder = models.BigIntegerField(blank=True, null=True)
    usercreated = models.BigIntegerField()
    usermodified = models.BigIntegerField()
    timecreated = models.BigIntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'mdl_reportbuilder_column'


class MdlReportbuilderFilter(models.Model):
    id = models.BigAutoField(primary_key=True)
    reportid = models.BigIntegerField()
    uniqueidentifier = models.CharField(max_length=255)
    heading = models.CharField(max_length=255, blank=True, null=True)
    iscondition = models.IntegerField()
    filterorder = models.BigIntegerField()
    usercreated = models.BigIntegerField()
    usermodified = models.BigIntegerField()
    timecreated = models.BigIntegerField()
    timemodified = models.BigIntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'mdl_reportbuilder_filter'


class MdlReportbuilderReport(models.Model):
    id = models.BigAutoField(primary_key=True)
    name = models.CharField(max_length=255, blank=True, null=True)
    source = models.CharField(max_length=255)
    type = models.IntegerField()
    uniquerows = models.IntegerField()
    conditiondata = models.TextField(blank=True, null=True)
    settingsdata = models.TextField(blank=True, null=True)
    contextid = models.BigIntegerField()
    component = models.CharField(max_length=100)
    area = models.CharField(max_length=100)
    itemid = models.BigIntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'mdl_reportbuilder_report'


class MdlReportbuilderSchedule(models.Model):
    id = models.BigAutoField(primary_key=True)
    reportid = models.BigIntegerField()
    name = models.CharField(max_length=255)
    enabled = models.IntegerField()
    ...
    subject = models.CharField(max_length=255)
    message = models.TextField()
    messageformat = models.BigIntegerField()
    userviewas = models.BigIntegerField()
    timescheduled = models.BigIntegerField()
    recurrence = models.BigIntegerField()
    reportempty = models.BigIntegerField()
    timelastsent = models.BigIntegerField()
    timenextsend = models.BigIntegerField()
    usercreated = models.BigIntegerField()
    usermodified = models.BigIntegerField()
    timecreated = models.BigIntegerField()
    timemodified = models.BigIntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'mdl_reportbuilder_schedule'
...
class MdlTaskScheduled(models.Model):
    ...
    hour = models.CharField(max_length=70)
...
class MdlTinyAutosave(models.Model):
    id = models.BigAutoField(primary_key=True)
    elementid = models.CharField(max_length=255)
    contextid = models.BigIntegerField()
    pagehash = models.CharField(max_length=64)
    ...
    class Meta:
        managed = False
        db_table = 'mdl_tiny_autosave'
        unique_together = (('elementid', 'contextid', 'userid', 'pagehash'),)


class MdlToolBrickfieldAreas(models.Model):
    id = models.BigAutoField(primary_key=True)
    type = models.IntegerField()
    contextid = models.BigIntegerField(blank=True, null=True)
    component = models.CharField(max_length=100, blank=True, null=True)
    tablename = models.CharField(max_length=40, blank=True, null=True)
    fieldorarea = models.CharField(max_length=50, blank=True, null=True)
    itemid = models.BigIntegerField(blank=True, null=True)
    filename = models.CharField(max_length=1333, blank=True, null=True)
    reftable = models.CharField(max_length=40, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'mdl_tool_brickfield_areas'


class MdlToolBrickfieldCacheActs(models.Model):
    id = models.BigAutoField(primary_key=True)
    courseid = models.BigIntegerField()
    status = models.IntegerField(blank=True, null=True)
    component = models.CharField(max_length=64, blank=True, null=True)
    totalactivities = models.BigIntegerField(blank=True, null=True)
    failedactivities = models.BigIntegerField(blank=True, null=True)
    passedactivities = models.BigIntegerField(blank=True, null=True)
    errorcount = models.BigIntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'mdl_tool_brickfield_cache_acts'


class MdlToolBrickfieldCacheCheck(models.Model):
    id = models.BigAutoField(primary_key=True)
    courseid = models.BigIntegerField()
    status = models.IntegerField(blank=True, null=True)
    checkid = models.BigIntegerField(blank=True, null=True)
    checkcount = models.BigIntegerField(blank=True, null=True)
    errorcount = models.BigIntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'mdl_tool_brickfield_cache_check'


class MdlToolBrickfieldChecks(models.Model):
    id = models.BigAutoField(primary_key=True)
    checktype = models.CharField(max_length=64, blank=True, null=True)
    shortname = models.CharField(max_length=64, blank=True, null=True)
    checkgroup = models.BigIntegerField(blank=True, null=True)
    status = models.SmallIntegerField()
    severity = models.IntegerField()

    class Meta:
        managed = False
        db_table = 'mdl_tool_brickfield_checks'


class MdlToolBrickfieldContent(models.Model):
    id = models.BigAutoField(primary_key=True)
    areaid = models.BigIntegerField()
    contenthash = models.CharField(max_length=40)
    ...
    class Meta:
        managed = False
        db_table = 'mdl_tool_brickfield_content'


class MdlToolBrickfieldErrors(models.Model):
    id = models.BigAutoField(primary_key=True)
    resultid = models.BigIntegerField()
    linenumber = models.BigIntegerField()
    errordata = models.TextField(blank=True, null=True)
    htmlcode = models.TextField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'mdl_tool_brickfield_errors'


class MdlToolBrickfieldProcess(models.Model):
    id = models.BigAutoField(primary_key=True)
    courseid = models.BigIntegerField()
    item = models.CharField(max_length=64, blank=True, null=True)
    contextid = models.BigIntegerField(blank=True, null=True)
    innercontextid = models.BigIntegerField(blank=True, null=True)
    timecreated = models.BigIntegerField(blank=True, null=True)
    timecompleted = models.BigIntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'mdl_tool_brickfield_process'


class MdlToolBrickfieldResults(models.Model):
    id = models.BigAutoField(primary_key=True)
    contentid = models.BigIntegerField(blank=True, null=True)
    checkid = models.BigIntegerField()
    errorcount = models.BigIntegerField()

    class Meta:
        managed = False
        db_table = 'mdl_tool_brickfield_results'


class MdlToolBrickfieldSchedule(models.Model):
    id = models.BigAutoField(primary_key=True)
    contextlevel = models.BigIntegerField()
    instanceid = models.BigIntegerField()
    contextid = models.BigIntegerField(blank=True, null=True)
    status = models.IntegerField()
    timeanalyzed = models.BigIntegerField(blank=True, null=True)
    timemodified = models.BigIntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'mdl_tool_brickfield_schedule'
        unique_together = (('contextlevel', 'instanceid'),)


class MdlToolBrickfieldSummary(models.Model):
    id = models.BigAutoField(primary_key=True)
    courseid = models.BigIntegerField()
    status = models.IntegerField(blank=True, null=True)
    activities = models.BigIntegerField(blank=True, null=True)
    activitiespassed = models.BigIntegerField(blank=True, null=True)
    activitiesfailed = models.BigIntegerField(blank=True, null=True)
    errorschecktype1 = models.BigIntegerField(blank=True, null=True)
    errorschecktype2 = models.BigIntegerField(blank=True, null=True)
    errorschecktype3 = models.BigIntegerField(blank=True, null=True)
    errorschecktype4 = models.BigIntegerField(blank=True, null=True)
    errorschecktype5 = models.BigIntegerField(blank=True, null=True)
    errorschecktype6 = models.BigIntegerField(blank=True, null=True)
    errorschecktype7 = models.BigIntegerField(blank=True, null=True)
    failedchecktype1 = models.BigIntegerField(blank=True, null=True)
    failedchecktype2 = models.BigIntegerField(blank=True, null=True)
    failedchecktype3 = models.BigIntegerField(blank=True, null=True)
    failedchecktype4 = models.BigIntegerField(blank=True, null=True)
    failedchecktype5 = models.BigIntegerField(blank=True, null=True)
    failedchecktype6 = models.BigIntegerField(blank=True, null=True)
    failedchecktype7 = models.BigIntegerField(blank=True, null=True)
    percentchecktype1 = models.BigIntegerField(blank=True, null=True)
    percentchecktype2 = models.BigIntegerField(blank=True, null=True)
    percentchecktype3 = models.BigIntegerField(blank=True, null=True)
    percentchecktype4 = models.BigIntegerField(blank=True, null=True)
    percentchecktype5 = models.BigIntegerField(blank=True, null=True)
    percentchecktype6 = models.BigIntegerField(blank=True, null=True)
    percentchecktype7 = models.BigIntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'mdl_tool_brickfield_summary'
...
class MdlToolUsertoursTours(models.Model):
    ...
    enabled = models.IntegerField()
    sortorder = models.BigIntegerField()
    endtourlabel = models.CharField(max_length=255, blank=True, null=True)
    configdata = models.TextField()
    displaystepnumbers = models.IntegerField()
