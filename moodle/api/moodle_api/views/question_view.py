"""ViewSets für Fragen (Questions) der Moodle-Datenbank."""
...
# ViewSet zum Abrufen und Filtern einzelner Fragen.
class QuestionViewSet(GenericViewSet):
    ...
    # Listet alle Fragen auf, optional gefiltert.
...
# ViewSet zum Abrufen aller Fragen-Antworten.
class QuestionsViewSet(GenericViewSet):
    ...
    # Listet alle Fragen-Antworten auf.
