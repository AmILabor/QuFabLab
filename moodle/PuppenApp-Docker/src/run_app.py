...
r = subprocess.run(['python3', path, "makemigrations"])
r = subprocess.run(['python3', path, "migrate"])
r = subprocess.run(['python3', path, "collectstatic","--noinput"])
